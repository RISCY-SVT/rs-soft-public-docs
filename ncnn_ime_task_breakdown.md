...
Главный показатель прогресса, замеряемый **каждую пятницу**. Гачко/Никулин видят прогресс по числу **FPS на 640×640 INT8**, а так же по количеству реализованных ядер, выполнению других задач согласно плана.  
